    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('finances.index') }}" class="btn btn-outline-secondary btn-sm shadow-sm">
        ...
        <div class="modal-content">
            <form action="{{ route('finances.payment') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div id="external_payment_section">
                        <div class="mb-3">
                            <label class="form-label">Monto Pagado (Externo)</label>
                            <div class="input-group">
                                <span class="input-group-text">{{ $loan->currency == 'USD' ? '$' : 'S/' }}</span>
                                <input type="number" step="0.01" class="form-control" name="amount" id="external_amount" required>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            <form id="editPaymentForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="payment_method_id" id="edit_p_method" value="">
                    <div class="mb-3">
                        <label class="form-label">Notas / Observaciones</label>
