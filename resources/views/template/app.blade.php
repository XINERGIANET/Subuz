...
<body>
	...
	@endphp
	<div class="page">
		<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark border-end-0 shadow"
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="sidebar-menu">
					...
					<div class="mobile-menu-header d-lg-none">
						...
						<button class="btn-close-mobile" data-bs-toggle="collapse" data-bs-target="#sidebar-menu"
					...
					<ul class="navbar-nav pt-lg-3">
						...
						@else
									...
									<div class="dropdown-menu">
										<div class="dropdown-menu-columns">
											<div class="dropdown-menu-column">
												...
												<a class="dropdown-item" href="{{ route('sales.jerry_can_report_view') }}">
													<i class="ti ti-bucket icon me-2"></i> Reporte de bidones
												</a>											</div>
										</div>
									</div>
								</li>
							...
							@if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('viewer') || auth()->user()->hasRole('asistente'))
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="#navbar-charges" data-bs-toggle="dropdown"
										data-bs-auto-close="false" role="button" aria-expanded="false">
										<span class="nav-link-icon d-md-none d-lg-inline-block">
		...
		<header class="navbar navbar-expand-md d-none d-lg-flex d-print-none">
			<div class="container-fluid">
				<button type="button" class="btn btn-icon btn-ghost-secondary me-3" id="sidebar-toggle"
				...
				<div class="container-xl">
					<div class="text-center">
						<span class="text-muted small">&copy; {{ date('Y') }} <span
								class="text-main fw-bold">xinergia</span>. Todos los derechos reservados.</span>
					</div>
				</div>
			</footer>
		</div>
