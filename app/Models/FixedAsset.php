...
class FixedAsset extends Model
{
    ...
    public function getClientSalesStatsAttribute()
    {
        ...
        return (object)[
            ...
            'first_sale_date' => $firstSale ? ($firstSale->date ? \Carbon\Carbon::parse($firstSale->date)->format('d/m/Y') : null) : null,
            'last_sale_date' => $lastSale ? ($lastSale->date ? \Carbon\Carbon::parse($lastSale->date)->format('d/m/Y') : null) : null,
            'cost' => $cost,
